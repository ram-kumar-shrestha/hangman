...
import { AddItemValidate } from "../../helpers"
import { addItem, addByproduct, getAllDropdownUnits } from "../../store/action"
import "./items.css"
...
const add_item = (
  ...
  >
    ...
    />
    <path
      id='a6f80ec2-9665-4b0d-9b96-9f178d319553-1354'
      data-name='Path 2621'
    ...
    />
    <path
      id='af435bc5-0b88-4d77-bfed-030ae9fdf7f6-1355'
      data-name='Path 2624'
    ...
    />
    <path
      id='e557133a-77b8-499f-bd16-c334895c1269-1356'
      data-name='Path 2625'
    ...
    />
    <path
      id='ec19a4b8-f44f-4645-b4d7-76344dff0125-1357'
      data-name='Path 2626'
    ...
    />
    <path
      id='e86d23b2-1618-4af8-9c24-b5d1e0a773ab-1358'
      data-name='Path 2627'
    ...
    />
    <path
      id='b5225405-dc09-4398-8f75-a858b019bf8f-1359'
      data-name='Path 2622'
    ...
    />
    <path
      id='a2f1c4f7-b8f3-4baf-98d5-81fcbaba2af5-1360'
      data-name='Path 2623'
    ...
    />
    <path
      id='b20583ce-2285-4a88-ae2b-42b53348cdcc-1361'
      data-name='Path 2642'
    ...
    />
    <path
      id='a69a945f-f2e5-47e0-ba72-38a008e8891a-1362'
      data-name='Path 2632'
    ...
    />
    <path
      id='e980cf0f-d800-4ee3-940e-45939556ba77-1363'
      data-name='Path 2633'
    ...
    />
    <path
      id='eba62579-0c8c-463a-8046-e804be002a11-1364'
      data-name='Path 2637'
    ...
    />
    <path
      id='e192092a-ee6f-4331-8843-6655178f0707-1365'
      data-name='Path 438'
    ...
    />
    <path
      id='a858933f-d134-4d1f-a5b1-d2ecd5f2e072-1366'
      data-name='Path 439'
    ...
    />
    <path
      id='f4641f1e-7695-45f0-a79a-94f4839885fa-1367'
      data-name='Path 440'
    ...
    />
    <path
      id='e7fd6c30-5753-49ca-a2fc-43310e28e2be-1368'
      data-name='Path 441'
    ...
    />
    <path
      id='b52aaf37-3203-4cbf-9b60-86692d62068e-1369'
      data-name='Path 442'
    ...
    />
    <path
      id='beff4645-a309-4245-bc03-2fdcf4e7d6c8-1370'
      data-name='Path 443'
    ...
    />
    <path
      id='a434c3a5-879f-494a-805a-60016a50852d-1371'
      data-name='Path 461'
    ...
    />
    <path
      id='eeef24b5-3622-48e4-8c10-5591845ab2d9-1372'
      data-name='Path 462'
...
const AddItem = ({ dropdown, addItem, addByproduct, getAllDropdownUnits }) => {
  const [message, setMessage] = useState({})
  const [backButton, setBackButton] = useState("")

  useEffect(() => {
    document.title = "Syanko Katti Roll - Add an Item"
    getAllDropdownUnits()
  }, [dropdown.length])
  ...
  const formik = useFormik({
    ...
    onSubmit: values => {
      // for raw items
      if (values.ItemType === "raw") {
        addItem(JSON.stringify(values))
          .then(() => {
            setBackButton(
              <Link
                to='../raw-items'
            ...
            setMessage({
              desc: "Raw Item added successfully",
              type: "success",
            })
          })
          .catch(e => {
      ...
      if (values.ItemType === "finished") {
        addByproduct(JSON.stringify(values))
          .then(() => {
            console.log("asd")
            setBackButton(
              <Link
            ...
            setMessage({
              desc: "Finished Item added successfully",
              type: "success",
            })
          })
          .catch(e => {
  ...
  return (
    <>
      <FormLayout formik={formik} title='Add an Item' svg={add_item} type='add'>
        {/* add item info */}
        <Info info={message} />
        ...
        <FormGroup
          ...
          options={dropdown?.map(optionItem => {
            return {
              id: optionItem.unitId,
              name: optionItem.unitName + " (" + optionItem.acronym + " )",
            }
          })}
        />
        ...
        <FormGroup
          ...
          error={formik.errors.MinimumStock}
          touched={formik.touched.MinimumStock}
        />
      </FormLayout>
    </>
  )
