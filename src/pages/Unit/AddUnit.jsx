...
import {addUnit} from '../../store/action'
...
const AddUnit = ({addUnit}) => {
  const [message, setMessage] = useState({})

  useEffect(() => {
    document.title = 'Syanko Katti Roll - Add a Unit'
  }, [])
  ...
  const formik = useFormik({
    ...
    onSubmit: values => {
      addUnit(JSON.stringify(values))
        .then(() => {
          setMessage({
            desc: 'Unit added successfully',
            type: 'success',
          })
        })
        .catch(e => {
  ...
  return (
    <>
      <FormLayout formik={formik} title="Add a Unit" svg={add_item} type="add">
        {/* add item info */}
        <Info info={message} />
        ...
        <FormGroup
          ...
          touched={formik.touched.Acronym}
        />
      </FormLayout>
    </>
  )
...
export default connect(null, {addUnit})(AddUnit)
